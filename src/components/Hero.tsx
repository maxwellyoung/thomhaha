...
const links = [
  {
    ...
    items: [
      {
        title: "SoundCloud",
        url: "https://soundcloud.com/thomhaha",
        icon: (
          <svg
      ...
      {
        title: "Instagram",
        url: "https://www.instagram.com/thomhaha",
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
const Hero = () => {
  return (
    <div className="bg-gray-95000 relative h-screen overflow-hidden">
      <div className="flex h-screen flex-col items-center justify-center">
        <Card className="overflow-hidden">
          <CardHeader>
            <CardTitle>Musician</CardTitle>
            <CardDescription>
              Here is a list of links to my solo projects & music I produced for
              other artists.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Accordion type="single" collapsible>
              {links.map((linkGroup, index) => (
                <AccordionItem key={index} value={linkGroup.category}>
                  <AccordionTrigger>{linkGroup.category}</AccordionTrigger>
                  <AccordionContent>
                    <div className="grid gap-2">
                      {linkGroup.items.map((link, linkIndex) => (
                        <a
                          ...
                          className="flex items-center rounded-md border border-gray-200 p-4 hover:bg-gray-100"
                        >
                          {link.icon}
                          <div className="ml-2">
